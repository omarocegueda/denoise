...
setup(
    ...
    ext_modules = [Extension("ornlm_module", ["ornlm_module.pyx", "ornlm.cpp", "upfirdn.cpp"],include_dirs=get_numpy_include_dirs(), extra_compile_args=["-msse2 -mfpmath=sse"], language="c++")]
)
